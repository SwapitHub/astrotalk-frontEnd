      ...
      <div className="breadcrumb">
        <ul>
          <li>
            ...
            <a href="#">Astromall</a>
            <a href="#">Gemstone</a>
            <span className="text">5 Ratti Yellow Citrine (Sunela)</span>
          </li>
        </ul>
      </div>
      </div>
          ...
          <div className="products-details-inner">
            ...
            <div className="product-details-right">
              <div className="product-right-desc">
                <h1>5 Ratti Yellow Citrine (Sunela)</h1>
                <p>
                  Increased wellness | Improved Fitness | Energized | Free
                  Shipping | Certificate Included | This image is for reference
                  only
                </p>
              </div>
              <div className="product-price">
                <span className="new-amount">₹ 1500</span>
                <span className="old-amount">₹ 2300</span>
              ...
              <div className="product-add-ons">
                ...
                <div className="product-add-ons-listing">
                  <div className="single-add-on">
                    <div className="add-on-img">
                      <img src="" alt="" />
                    </div>
                    <div className="add-on-details">
                      <div className="addon-name">Bronze Ring</div>
